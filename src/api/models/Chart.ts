...
import muhurtaValues from "./../mappings/muhurta-values";
import caughadiaData from "./../mappings/caughadia-data";
import kalamData from "./../mappings/kalam-data";
import karanaData from "./../mappings/karana-data";
import horaValues from "./../mappings/hora-values";
import tithiValues from "./../mappings/tithi-values";
import varaValues from "./../mappings/vara-values";
import yogaValues from "./../mappings/yoga-values";
import { Graha } from "./Graha";
import { KaranaSet } from "./KaranaSet";
import { MuhurtaSet, MuhurtaItem } from "./MuhurtaSet";
...
export class Chart {
  ...
  getVara() {
    if (this.hasIndianTime) {
      ...
      const weekDay = weekDayNumIso(this.datetime, dayBefore);
  ...
  matchCaughadia(showDefault = true) {
    ...
    if (this.hasIndianTime) {
      ...
      const jd = this.jd;
      const weekDay = weekDayNum(this.datetime, dayBefore, false);
      ...
      if (caughadiaDayRow) {
        const caughadiaStart = useDayTime
